...
export default class CardPlayer extends CardDraggable {
  textHealth: Phaser.GameObjects.BitmapText;
  textMaxHealth: Phaser.GameObjects.BitmapText;
  textArmor: Phaser.GameObjects.BitmapText;
  spriteArmor: Phaser.GameObjects.Sprite;
  private _health: any;
  private _maxHealth: any;
  private _armor: any;
